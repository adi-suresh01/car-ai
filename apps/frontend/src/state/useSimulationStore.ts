...
const ROLLING_RESIST_MPS2 = 0.15;
const AERO_DRAG_COEFF = 0.0032;
...
const deriveDashboardState = (
  ...
  return {
    activeApp: "assistant",
    headline: voiceStatus.summary ? "Voice Update" : "Voice Command",
    detail: voiceStatus.summary ?? "Command received.",
    tone: "info",
